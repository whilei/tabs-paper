...
%TODO cite why we can assume Poisson. Its in the LITERATURE.

We examined comparable data from the Etherum (ETH) and Ethereum Classic (ETC) blockchains
...
Further, we derived the mean block time for both networks, yielding approximately 13.5 seconds for both chains.
From this, for the sake of argument, we assume a general mean block interval as a round 14 seconds.
