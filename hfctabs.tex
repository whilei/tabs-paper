...
\subsection{\normalsize{Expected network uncle rate}}

The network's uncle rate is the generalization of the previous argument.

Since the uncle rate for a network can be (albeit somewhat loosely)
