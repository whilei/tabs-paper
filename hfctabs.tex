...
However, in this example, there could be no trustless guarantee that the miner would hold the transaction exclusively
before including it in a block.
It could be resold, publicized, ignored -- all at the miner's discretion.
