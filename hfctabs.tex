...
facilitating a near-constant block emission rate for the network.
...
\begin{equation}
    \tabsAdjustmentDenominator \equiv 2049
%    \begin{cases}
...
The constant $\tabsAdjustmentDenominator$ is defined relative to the incumbent
Ethereum difficulty adjustment factor (
    $\left\lfloor\frac{{P(H)_{\mathrm{H}}}_{\mathrm{d}}}{2048}\right\rfloor$
)
with $\tabsAdjustmentDenominator$ being marginally less in order to maintain the precedence of the difficulty value
in the resulting Consensus Score product.
...
and that determination of the considered interval should be made
