...
%%The necessary general characteristics of the pre-existing canonical-arbitration algorithm conditions are not defined nor
...
We detail the associated additional risk to the network, which we show to
